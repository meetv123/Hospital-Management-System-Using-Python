...
class Application:
    def __init__(self, master):
        ...
        self.heading = Label(self.left, text="Trivy Hospital Appointments", font=('arial 40 bold'), fg='black', bg='lightgreen')
        self.heading.place(x=0, y=0)
        self.heading = Label(self.left, text="Shivansh Agarwal || Gayatri Nair || Meet Vanani", font=('arial 10'), fg='black', bg='lightgreen')
